...
class Robot:
    ...
    def tolerance(self, value: float):
        ...
        if float_value > Eps.eps05:
            raise ValueError(f"Tolleranza troppo alta (tolleranza massima = {Eps.eps05}).")

        self._tolerance = float_value

    def validate_point(self, point: ArrayLike) -> bool:
